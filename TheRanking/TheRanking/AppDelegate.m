...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    TRMasterViewController *viewController = [[TRMasterViewController alloc] initWithNibName:@"TRMasterViewController" bundle:nil];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.jeff.TheRanking" in the application's documents directory.

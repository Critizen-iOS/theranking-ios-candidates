...
@interface CoreDataCollectionVC()
@property (strong, nonatomic) NSMutableArray *objectChanges;
@property (strong, nonatomic) NSMutableArray *sectionChanges;
@end

@implementation CoreDataCollectionVC
...
- (void)performFetch
{
    if (self.fetchedResultsController) {
        ...
        if (error) ELog(@"[%@ %@] %@ (%@)", NSStringFromClass([self class]), NSStringFromSelector(_cmd), [error localizedDescription], [error localizedFailureReason]);
    } else {
